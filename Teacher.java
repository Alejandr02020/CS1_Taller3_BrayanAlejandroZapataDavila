...
public class Teacher extends Person implements Material {

    public Teacher(String id, String names, String lastNames, String rol, int numberLoans, int numberRenewals) {
